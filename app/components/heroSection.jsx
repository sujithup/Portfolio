      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-8 place-self-center  max-w-[750px] text-center sm:text-left justify-self-start">
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block bg-slate-800 py-3 w-full sm:w-fit rounded-full mr-4 hover:opacity-80 text-white"
            >
              Contact Me
            </Link>
            <Link
              href="/"
              className="px-1 inline-block bg-slate-800 py-1 w-full sm:w-fit rounded-full hover:bg-slate-800 text-white mt-3"
            >
