...
const Skills = () => {
  return (
    <section className="text-white" id="skills">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2  lg:grid-cols-3  py-10">
        {skills.map((skill, index) => {
          const Icon = skill.icons;
          return (
            <div
              key={index}
              className="rounded-md mb-10 md:mr-10 overflow-hidden ring-2 ring-neutral-200  hover:ring-pink-400 relative z-20"
            >
